...
AllowNoIcons=yes
OutputDir=.
OutputBaseFilename=ListeningTrainer_Setup_{#MyAppVersion}
...
[Run]
Filename: "{app}\{#MyAppExeName}"; Description: "Run ListeningTrainer"; Flags: nowait postinstall skipifsilent
